...
import { modalVariants, transitions } from '../../lib/animations'
        ...
        <div className="fixed inset-0 z-50">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-4 sm:p-6">
            <motion.div
              ...
              className="w-full max-w-lg sm:max-w-xl rounded-xl bg-white shadow-lg"
            >
              {/* Header */}
                ...
                <div className="mt-4 sm:mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
                  <div>
                    ...
                    >
                      ...
                      <option value="Reading with COC Formula (PDF)">
                        Reading with COC Formula
                      </option>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Cocoa Break Collection (Audiobook)">
